            ...
            <v-card-text class="text-xs-center">
              ...
              <p class="subheading grey--text">
                ...
                <div style="text-align:center;position:relative">
                    ...
                    <v-btn v-if="!taked" @click="takePhoto" style="position:absolute;bottom:0;left:50%;transform:translate(-50%,-50%);z-index:99" icon> <v-icon color="white">mdi-camera</v-icon> </v-btn>
                    <div class="electricity electricity-for-camera"></div>
                    <canvas ref="photoCanvas" style="position:absolute;left:50%;transform:translate(-50%,-50%);top:48%;height:100%;width:300px;"></canvas>
                    <v-btn v-if="taked" @click="cancelPhoto" style="position:absolute;top:5%;left:80%;transform:translate(-50%,-50%);z-index:99" icon > <v-icon color="white"> mdi-close </v-icon>  </v-btn>
                </div>
            <v-container>
