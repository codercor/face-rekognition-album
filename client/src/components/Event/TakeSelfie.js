...
import {
    Container, Stack, Box, Typography, Button, Grid, IconButton
} from '@mui/material'
        ...
        <Box sx={{
            ...
            <Grid container justifyContent="center" spacing={2}>
                <Grid item style={{
                    ...
                    {photo && <><img style={{ position: 'absolute', left: 18 }} src={photo} />
                ...
                <Grid item xs={12}>
                    ...
                    {photo != "" ? <Button fullWidth onClick={handleConfirm} variant="contained" color="success" >
                        OK !    <Icon path={mdiHandOkay} size={1} color="white" />
                    </Button> : <Button fullWidth onClick={handleTakePhoto} variant='contained' sx={{ backgroundColor: 'purple' }} >
